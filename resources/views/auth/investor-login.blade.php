...
@section('title', 'Investor Login | Intern Estate')
    ...
    <div class="container login-grid login-grid-single">
        <div class="login-card">
            <div class="login-card-header">
                ...
                <p>Enter your investor account details to continue.</p>
            </div>
            <form method="POST" action="{{ route('investor.login.attempt') }}" class="login-form">
                @csrf
