...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $lawyer = Lawyer::updateOrCreate(['email'=>'farhana@internestate.test'], ['name'=>'Adv. Farhana Islam','phone'=>'+8801711000000','specialization'=>'Land & Property Law','active_cases_count'=>22]);
        Lawyer::updateOrCreate(['email'=>'kazi.rahman@internestate.test'], ['name'=>'Adv. Kazi Abdul Rahman','phone'=>'+8801812345678','specialization'=>'Real Estate & JV Contracts','active_cases_count'=>1]);
        Lawyer::updateOrCreate(['email'=>'sultana.razia@internestate.test'], ['name'=>'Adv. Sultana Razia','phone'=>'+8801911223344','specialization'=>'Title Search & Deed Vetting','active_cases_count'=>0]);
        Lawyer::updateOrCreate(['email'=>'mahmud.hassan@internestate.test'], ['name'=>'Adv. Mahmud Hassan','phone'=>'+8801611556677','specialization'=>'Land Survey & Litigation','active_cases_count'=>0]);
